...
<body>
    ...
    <div class="container  d-flex justify-content-center align-items-center">
         <div class="position-relative">
             <div class="card p-4 text-center" style="height: 403px;">
            ...
            <div class="card-2">
                ...
                <form action="{{route('User.ResendOTP')}}" method="post">
                    ...
                    <button type="submit" style="background: #50a1e3; color: white;border-radius: 5px; padding: 3px 10px;">Resend</button>
                </form>
