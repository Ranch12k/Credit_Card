<html lang="en">
  ...
  <body>
    <div class="form-container">
      ...
      <h3 class="text-center mb-4"> Verification Page</h3>
      <form method="POST" action="{{ route('User.VerifiedUser') }}" id="VerificationPage">
        @csrf
        ...
        @endif
        <h4>ReEnter Your Email And Passoword!!</h4>
